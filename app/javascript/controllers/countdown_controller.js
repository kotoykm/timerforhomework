...
export default class extends Controller {
  ...
  connect() {
    console.log("Conectado al controlador de countdown");
  ...
  countdown(){
    ...
    if (secondsRemaining <= 0){
      ...
      this.countdownTarget.innerHTML = "¡¡Se terminó el tiempo!!";
      return;
    }
    ...
    this.countdownTarget.innerHTML = `${days} días, ${hours} horas, ${minutes} minutos, ${seconds} segundos`;
  }
